    ...
    <div className="flex flex-col items-center justify-center">
      ...
      {weatherData && (
        <div className="relative rounded-xl shadow-lg p-4 bg-white dark:bg-gray-800 transition-all duration-300">
          <h2 className="text-2xl font-semibold text-center my-2 text-[#16a34a]">
          ...
          {forecastData && (
            <div>
              <h2 className="text-md font-semibold text-center mt-4">3-Day Forecast</h2>
              <div className="grid grid-cols-2 gap-2">
                {forecastData.forecast.forecastday.map((day) => (
                  <div key={day.date} className="border p-2 rounded-lg bg-gray-100 dark:bg-gray-700">
                    ...
                    <div className="flex items-center">
                      ...
                      <p className="text-sm mb-2">Condition: {day.day.condition.text}</p>
                    </div>
                  </div>
                ))}
              </div>
