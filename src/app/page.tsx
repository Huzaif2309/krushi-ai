	...
	return (
		<div className="flex flex-1 flex-col min-h-screen p-4">
			<div className="relative flex h-[50vh] w-full flex-col items-center justify-center overflow-hidden rounded-lg bg-background">
				<h1 className="text-6xl md:text-8xl font-bold text-[#16a34a]">Krushi-AI</h1>
        <p className="text-xl md:text-3xl mx-10 text-center my-4">Transforming agriculture with precision and power, Krushi AI empowers farmers to achieve unmatched productivity and success. Elevate your farming journey today.</p>
				<Particles
